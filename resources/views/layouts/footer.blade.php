 <!-- subscribe-section -->
        <section class="subscribe-section bg-color-3">
            <div class="pattern-layer" style="background-image: url({{ asset('user/assets/images/shape/shape-2.png') }});"></div>
                                ...
                                <div class="post-inner">
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img
                                                    src="{{ asset('user/assets/images/resource/footer-post-1.jpg') }}" alt=""></a>
                                        </figure>
                                    ...
                                    <div class="post">
                                        <figure class="post-thumb"><a href="blog-details.html"><img
                                                    src="{{ asset('user/assets/images/resource/footer-post-2.jpg') }}" alt=""></a>
                                        </figure>
